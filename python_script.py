...
class csv_to_excel:
    ...
    def convert_csv_to_xls(self):
        try:
            ...
            if(len(df) == 0):	
                ...
                with pd.ExcelWriter('001.xls') as writer:
    ...
    def display_xls_file(self):
        try:
            self.file_name = filedialog.askopenfilename(initialdir = r'C:\Users\Admin-Pc\Desktop\gui\Files for task 2 and 4\Object 1\side2-1.6\data\001.csv',
...
# Driver Code
root = Tk()
root.title('ExcelSheet---Convert CSV to Excel File')
